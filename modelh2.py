...
inputData=pd.read_csv(r'C:\Users\vishw\Desktop\Projects\Publishing\hippocampus2.csv') #Import aand saving the dataset in a variable
...
inputData.drop(columns=['t', 'B', 'Gene.title'], axis=1).to_csv('finalDatah2.csv', index=False) #Removal of undesirable columns ans saving the rest of the data in a new CSV file
finalDatah2=pd.read_csv(r'C:\Users\vishw\Desktop\Projects\Publishing\finalDatah2.csv') #Importing and saving the new dataset
print(finalDatah2.isnull().sum(), end='\n\n\n')
print(finalDatah2.dtypes, end='\n\n\n') #Check the data types of the columns in the dataset
reference_genes_set=set(reference_genes['Gene.symbol'])

X = finalDatah2[['logFC', 'P.Value', 'adj.P.Val']] #Features variable
y_str = finalDatah2['Gene.symbol'] #Target variable
