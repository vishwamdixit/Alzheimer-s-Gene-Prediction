...
inputData=pd.read_csv(r'C:\Users\vishw\Desktop\Projects\Publishing\frontalcortex.csv') #Import aand saving the dataset in a variable
...
inputData.drop(columns=['t', 'B', 'Gene.title'], axis=1).to_csv('finalDatafc.csv', index=False) #Removal of undesirable columns ans saving the rest of the data in a new CSV file
finalDatafc=pd.read_csv(r'C:\Users\vishw\Desktop\Projects\Publishing\finalDatafc.csv') #Importing and saving the new dataset
print(finalDatafc.isnull().sum(), end='\n\n\n')
print(finalDatafc.dtypes, end='\n\n\n') #Check the data types of the columns in the dataset
reference_genes_set=set(reference_genes['Gene.symbol'])

X = finalDatafc[['logFC', 'P.Value', 'adj.P.Val']] #Features variable
y_str = finalDatafc['Gene.symbol'] #Target variable
